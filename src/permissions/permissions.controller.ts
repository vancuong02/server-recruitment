...
export class PermissionsController {
    ...
    create(@User() user: IUser, @Body() createPermissionDto: CreatePermissionDto) {
    ...
    update(@User() user: IUser, @Param('id') id: string, @Body() updatePermissionDto: UpdatePermissionDto) {
