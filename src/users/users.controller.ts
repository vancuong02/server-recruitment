...
export class UsersController {
    ...
    changePassword(@User() user: IUser, @Body() changePasswordDto: ChangePasswordDto) {
        console.log(user)
    ...
    update(@Param('id') id: string, @Body() updateUserDto: AdminUpdateUserDto, @User() user: IUser) {
